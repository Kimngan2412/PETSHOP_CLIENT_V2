            ...
            <div className="footer-items contact ">
              ...
              <div className="hotline mb-30">
                ...
                <div className="hotline-info">
                  ...
                  <h6>
                    <a href="tel:+84905037310">+84 905 0373 10</a>
                  </h6>
                </div>
              </div>
              <div className="email mb-30">
                ...
                <div className="email-info">
                  <h6 className="mb-10">
                    <a href="mailto:kimngantruong2412@gmail.com">
                      kimngantruong2412@gmail.com
                    </a>
                  </h6>
                  <h6>
                    <a href="mailto:muoptay2412@gmail.com">
                      muoptay2412@gmail.com
                    </a>
                  </h6>
                </div>
              </div>
              <div className="email">
                ...
                <div className="email-info">
                  <h6 className="mb-10">
                    <a>4/2/1 Ong Ich Khiem</a>
                  </h6>
                  <h6>
                    <a>Thanh Binh, Hai Chau, Da Nang, Viet Nam</a>
                  </h6>
                </div>
              </div>
            </div>
